...
cc_anti_behavior <- function(path_ID, frame_rate, length_pix) {
  ...
  chamber_div <- 168 ## the lenght of two chambels and the gap between
  ...
  return(list(ratio_time, cross_latency_1st, cross_latency_2nd, total_distance, speed_to_nor_1st, speed_to_hot_1st, total_cross))
}
